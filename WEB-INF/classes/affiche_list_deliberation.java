...
public class affiche_list_deliberation {
    private int id_semestre;

    public affiche_list_deliberation(int id_semestre) {
    ...
    public String affiche(Connection c) throws Exception {
        ...
        if (this.id_semestre == 2 || this.id_semestre == 3 || this.id_semestre == 4) {
            ...
            for (int i = 0; i < list_int.length; i++) {
                ...
                if (rs_etudiant.next()) {
                    ...
                    html.append("<td><a href=\"deliberation.jsp\">" + matricule + "</a></td>");
                    html.append("<td>" + nom + "</td>");
                }
                double moyenne = rs.get_moyenne(list_int[i], c);

                html.append("<td>" + moyenne + "</td>");
                html.append("<td><a href=\"notes.jsp?id_eleve=" + list_int[i] + "&id_semestre=" + id_semestre
                        + "\">Notes</a></td>");
                html.append("</tr>");
        ...
        if (this.id_semestre == 5 || this.id_semestre == 6 || this.id_semestre == 7) {
            ...
            int[] list_int1 = rs1.list_deliberation();
            int[] list_int2 = rs2.list_deliberation();
            int[] list_int3 = rs3.list_deliberation();
            ...
            for (int i = 0; i < list_int1.length; i++) {
                ...
                html.append("<td>" + moyenne + "</td>");
                html.append("<td><a href=\"notes.jsp?id_eleve=" + list_int1[i] + "&id_semestre=" + id_semestre
                        + "&parcour=" + 1 + "\">Notes</a></td>");
                html.append("</tr>");
            ...
            for (int i = 0; i < list_int2.length; i++) {
                ...
                html.append("<td>" + moyenne + "</td>");
                html.append("<td><a href=\"notes.jsp?id_eleve=" + list_int2[i] + "&id_semestre=" + id_semestre
                        + "&parcour=" + 2 + "\">Notes</a></td>");
                html.append("</tr>");
            ...
            for (int i = 0; i < list_int3.length; i++) {
                ...
                html.append("<td>" + moyenne + "</td>");
                html.append("<td><a href=\"notes.jsp?id_eleve=" + list_int3[i] + "&id_semestre=" + id_semestre
                        + "&parcour=" + 3 + "\">Notes</a></td>");
                html.append("</tr>");
