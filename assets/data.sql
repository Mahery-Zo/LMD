...
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF101', 12);
...
-- Semestre 4
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF204', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF205', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF206', 12);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF207', 15);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF210', 16);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'MTH204', 10);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'MTH205', 12);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'MTH206', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'MTH203', 9);

-- Semestre 5
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF301', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF304', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF307', 16);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'ORG301', 15);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'ORG302', 12);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'ORG303', 10);


-- Semestre 6
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF310', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF313', 15);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF302', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF303', 16);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'INF316', 18);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 1, 'ORG304', 14);


--Note pour les matiere base 
-- Semestre 4
INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 1, 'INF205', 13
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 1 AND Matiere = 'INF205');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 1, 'INF204', 14
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 1 AND Matiere = 'INF204');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 1, 'INF206', 15
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 1 AND Matiere = 'INF206');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 1, 'INF207', 16
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 1 AND Matiere = 'INF207');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 1, 'INF211', 14
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 1 AND Matiere = 'INF211');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 1, 'MTH202', 10
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 1 AND Matiere = 'MTH202');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 1, 'MTH205', 12
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 1 AND Matiere = 'MTH205');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 1, 'MTH206', 14
FROM dual
...
--Note pour les matieres DEV
-- Semestre 4
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF204', 9);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF205', 12);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF206', 8);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF207', 11);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF210', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'MTH204', 5);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'MTH205', 7);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'MTH206', 10);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'MTH203', 4);

-- Semestre 5
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF301', 11);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF304', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF307', 16);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'ORG301', 9);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'ORG302', 6);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'ORG303', 8);

-- Semestre 6
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF310', 12);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF313', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF302', 7);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF303', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'INF316', 18);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 2, 'ORG304', 10);
...
-- Semestre 4
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF204', 8);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF205', 15);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF206', 11);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF207', 17);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF210', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'MTH204', 6);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'MTH205', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'MTH206', 16);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'MTH203', 5);

-- Semestre 5
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF301', 12);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF304', 18);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF307', 10);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'ORG301', 15);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'ORG302', 9);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'ORG303', 11);

-- Semestre 6
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF310', 7);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF313', 18);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF302', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF303', 9);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'INF316', 16);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 3, 'ORG304', 10);

-- Note pour les matières BASE
-- Semestre 4
INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 3, 'INF205', 14
FROM dual
...
-- Semestre 5
INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 3, 'INF303', 16
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 3 AND Matiere = 'INF303');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 3, 'INF306', 18
FROM dual
...
INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 3, 'ORG302', 10
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 3 AND Matiere = 'ORG302');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 3, 'ORG303', 17
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 3 AND Matiere = 'ORG303');

-- Semestre 6
INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 3, 'INF312', 19
FROM dual
...
--Note pour les matieres DEV
-- Semestre 4
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF204', 9);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF205', 8);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF206', 7);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF207', 18);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF210', 19);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'MTH204', 6);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'MTH205', 10);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'MTH206', 12);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'MTH203', 5);

-- Semestre 5
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF301', 17);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF304', 18);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF307', 15);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'ORG301', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'ORG302', 9);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'ORG303', 8);

-- Semestre 6
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF310', 10);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF313', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF302', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF303', 16);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'INF316', 20);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 4, 'ORG304', 12);

--Note pour les matieres base
-- Semestre 4
INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 4, 'INF205', 15
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 4 AND Matiere = 'INF205');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 4, 'INF204', 10
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 4 AND Matiere = 'INF204');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 4, 'INF206', 14
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 4 AND Matiere = 'INF206');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 4, 'INF207', 16
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 4 AND Matiere = 'INF207');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 4, 'INF211', 12
FROM dual
...
INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 4, 'INF206', 12
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 4 AND Matiere = 'INF206');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 4, 'INF209', 17
FROM dual
...
-- Note pour les matieres DEV
-- Semestre 4
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF204', 16);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF205', 12);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF206', 10);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF207', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF210', 18);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'MTH204', 8);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'MTH205', 11);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'MTH206', 15);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'MTH203', 7);

-- Semestre 5
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF301', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF304', 15);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF307', 17);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'ORG301', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'ORG302', 9);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'ORG303', 11);

-- Semestre 6
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF310', 12);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF313', 14);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF302', 16);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF303', 13);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'INF316', 17);
INSERT INTO Note (id_classe, id_eleve, Matiere, note) VALUES (1, 5, 'ORG304', 16);

-- Note pour les matieres base
-- Semestre 4
INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 5, 'INF205', 12
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM Note WHERE id_eleve = 5 AND Matiere = 'INF205');

INSERT INTO Note (id_classe, id_eleve, Matiere, note)
SELECT 1, 5, 'INF204', 16
FROM dual
